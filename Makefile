...
npm:
	...
	echo "try { module[\"exports\"] = require(\"@nicolasflamel/smaz-native\");} catch(error) {} if(Object.keys(module[\"exports\"])[\"length\"] === 0) { const smaz = (typeof WebAssembly !== \"undefined\") ? require(\"./wasm.js\") : require(\"./asm.js\");" > "./index.js"
